...
export async function ensureDefaultStatusEscalationRules(organizationId: string) {
  ...
  const defaults = [
    ...
    { entityType: "project", status: "Arbeit unterbrochen", name: "Projektarbeit unterbrochen", thresholdHours: 48 },
    { entityType: "project", status: "Abrechnungsprüfung", name: "Projekt in Abrechnungsprüfung", thresholdHours: 72 },
    ...
    { entityType: "potential", status: "lost", name: "Potenzial aktuell kein Interesse", thresholdHours: 720 },
    { entityType: "potential", status: "completed", name: "Potenzial durchgeführt", thresholdHours: 720 },
    ...
    { entityType: "potential", status: "open", name: "Potenzial festgestellt", thresholdHours: 168 },
    { entityType: "project", status: "Lead / Klärung", name: "Projekt in Lead / Klärung", thresholdHours: 168 },
