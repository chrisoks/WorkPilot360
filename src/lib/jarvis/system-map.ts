...
const MAIN_AREAS: JarvisSystemArea[] = [
  ...
  moduleArea("projectsSolutions", "Projekte OK solutions", "Solutions-Projekte nach Projektart und Status bearbeiten.", ["Projekt suchen", "Projektakte öffnen", "Projektstatus und Verantwortlichkeit prüfen"], [Role.ADMIN, Role.GESCHAEFTSFUEHRER, Role.FUEHRUNGSKRAFT, Role.MITARBEITER, Role.VERTRIEB], ["solutions projekte"]),
  ...
  moduleArea("calculators", "Kalkulations-Rechner", "Fachkalkulationen für Winterdienst, Fahrten und Fahrzeuge.", ["Kalkulationsart wählen", "Grundlagen erfassen", "Ergebnis speichern oder übernehmen"], OPERATIVE_ROLES, ["rechner", "kalkulation"]),
  ...
  moduleArea("accounting", "Buchhaltung", "Rechnungen, offene Posten, Dokumente und Stapelabrechnung.", ["Rechnungen prüfen", "offene Posten bearbeiten", "Abrechnung vorbereiten"], ACCOUNTING_NAVIGATION_ROLES, ["finanzen", "rechnungen"]),
...
const CALCULATOR_AREAS = [
  ...
  childArea({ id: "calculators.vehicles", label: "Fahrzeuge", kind: "calculator", parentId: "calculators", tab: "calculators", purpose: "Fahrzeugstammdaten für Kalkulation und Vermietung.", workflows: ["Fahrzeug suchen", "Verbrauch und Kilometerwerte prüfen", "berechtigt bearbeiten"], roles: MANAGEMENT_ROLES, sourceRefs: ["src/components/calculators/vehicle-module.tsx"] }),
