...
const groups: Record<string, string[]> = {
  ...
  time: [
    "Welche Zeiten habe ich heute gestempelt?", "Erfasse zwei Stunden auf Projekt GLR-449.", "Welche Projektzeiten sind noch offen?", "Welche Zeiten sind keiner Rechnung zugeordnet?", "Wechsle meine Stempelung zur Folgetätigkeit unproduktiv. Unproduktive Tätigkeit: QA Büroorganisation; Neue Tätigkeit: QA Ablage prüfen", "Zeig mir meine Wochenstunden.", "Beende meine laufende Stempelung.", "Welche Überstunden warten auf Freigabe?", "Starte meine Stempelung unproduktiv. Unproduktive Tätigkeit: QA JARVIS Korpus; Tätigkeit: Vorschauprüfung", "Pausiere meine laufende Stempelung.",
  ],
  calculators: [
