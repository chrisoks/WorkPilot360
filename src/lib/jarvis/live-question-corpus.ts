...
const groups: Record<string, string[]> = {
  ...
  time: [
    "Welche Zeiten habe ich heute gestempelt?", "Erfasse zwei Stunden auf Projekt GLR-449.", "Welche Projektzeiten sind noch offen?", "Welche Zeiten sind keiner Rechnung zugeordnet?", "Warum wurde dieser Zeiteintrag abgelehnt?", "Zeig mir meine Wochenstunden.", "Beende meine laufende Stempelung.", "Welche Überstunden warten auf Freigabe?", "Starte meine Stempelung unproduktiv. Unproduktive Tätigkeit: QA JARVIS Korpus; Tätigkeit: Vorschauprüfung", "Pausiere meine laufende Stempelung.",
  ],
  calculators: [
