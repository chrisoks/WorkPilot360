...
const groups: Record<string, string[]> = {
  ...
  invoices: [
    "Erstelle einen Rechnungsentwurf für Projekt GLR-449.", "Erstelle eine Rechnung für OK immocare mit Leistungsdatum 31.07.2026.", "Fakturiere Rechnungsentwurf RE-10124 kontrolliert.", "Welche Nachweise fehlen vor der Fakturierung?", "Markiere Rechnung RE-10119 am 31.07.2026 kontrolliert als bezahlt.", "Erstelle eine Mahnung für Rechnung RE-10119 mit Zahlungsfrist bis 07.08.2026.", "Zeig mir offene Rechnungen.", "Warum ist diese Rechnung noch nicht fakturierbar?", "Sende Rechnung RE-10124 kontrolliert mit sichtbarer Empfänger- und Dokumentvorschau.", "Welche Forderungen sind überfällig?",
  ],
  onlineRequests: [
