...
const groups: Record<string, string[]> = {
  ...
  time: [
    "Welche Zeiten habe ich heute gestempelt?", "Erfasse zwei Stunden auf Projekt GLR-449.", "Welche Projektzeiten sind noch offen?", "Welche Zeiten sind keiner Rechnung zugeordnet?", "Warum wurde dieser Zeiteintrag abgelehnt?", "Zeig mir meine Wochenstunden.", "Welche Pausen fehlen?", "Welche Überstunden warten auf Freigabe?", "Ordne den Zeiteintrag der Abrechnungsleistung zu.", "Pausiere meine laufende Stempelung.",
  ],
  calculators: [
