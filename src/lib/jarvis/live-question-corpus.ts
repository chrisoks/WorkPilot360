...
const groups: Record<string, string[]> = {
  ...
  projects: [
    "Wie ist der aktuelle Stand von Projekt GLR-449?", "Welche Projekte sind wirtschaftlich auffällig?", "Setze Projekt QA-100 auf Angebot. Grund: Der Angebotsprozess wurde fachlich eröffnet.", "Welche Dauerläufer haben offene Monate?", "Zeig mir das nächste geplante Ereignis im Projekt GLR-449.", "Warum muss ich einen Kundenhinweis vor der Projektanlage bestätigen?", "Archiviere Projekt QA-200. Grund: Auftrag abgeschlossen und revisionssicher geprüft.", "Welche Projektzeiten sind noch nicht abgerechnet?", "Was bewirkt halbjährlich als Fakturierungsintervall?", "Ändere Projekt QAM-300: Titel: QA JARVIS Projektdaten geprüft; Laufzeit bis: 2026-11.",
  ],
  customers: [
    "Zeig mir den Kunden zu Projekt GLR-449.", "Welche Kunden haben offene Forderungen?", "Welche Kunden machen den meisten Umsatz?", "Welche Kundenbeziehungen sind gefährdet?", "Welche Ansprechpartner sind im Projekt hinterlegt?", "Lege einen neuen Firmenkontakt QAC-400 kontrolliert an.", "Warum kann ich für einen Interessenten noch kein Projekt anlegen?", "Welche offenen Aufgaben gibt es für den Kunden?", "Lösche Kontakt QAD-500 endgültig. Grund: Versehentliche Doppelanlage.", "Was gehört ins Sales-Journal?",
  ],
  tasks: [
  ...
  planning: [
    "Welche Termine habe ich heute?", "Plane einen Termin für Projekt GLR-449.", "Plane zwei Mitarbeiter gemeinsam für den Einsatz ein.", "Erstelle einen Terminwunsch für nächsten Montag.", "Welche Monatspauschale hat noch freies Kontingent?", "Wie viel Angebotskontingent ist noch frei?", "Plane eine wöchentliche Terminserie.", "Entscheide eine gesamte Terminwunschserie: freigeben, ablehnen, zurückziehen oder bestätigte Terminserie absagen.", "Darf ich einen Leistungsmonat außerhalb der Projektlaufzeit planen?", "Verschiebe eine komplette Terminserie ab einem ausgewählten Termin gemeinsam.",
  ],
  time: [
    "Wird die Pause von der Nettoarbeitszeit doppelt abgezogen?", "Erfasse zwei Stunden auf Projekt GLR-449.", "Was passiert mit einem manuellen Zeiteintrag beim Stunden-Dauerläufer?", "Welche Zeiten sind keiner Rechnung zugeordnet?", "Wechsle meine Stempelung zur Folgetätigkeit unproduktiv. Unproduktive Tätigkeit: QA Büroorganisation; Neue Tätigkeit: QA Ablage prüfen", "Korrigiere einen Zeiteintrag. Grund: Uhrzeit falsch. Beginn: 08:15", "Beende meine laufende Stempelung.", "Welche Überstunden warten auf Freigabe?", "Starte meine Stempelung unproduktiv. Unproduktive Tätigkeit: QA JARVIS Korpus; Tätigkeit: Vorschauprüfung", "Pausiere meine laufende Stempelung.",
  ],
  calculators: [
