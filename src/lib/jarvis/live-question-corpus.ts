...
const groups: Record<string, string[]> = {
  ...
  customers: [
    "Zeig mir den Kunden zu Projekt GLR-449.", "Welche Kunden haben offene Forderungen?", "Welche Kunden machen den meisten Umsatz?", "Welche Kundenbeziehungen sind gefährdet?", "Welche Ansprechpartner sind im Projekt hinterlegt?", "Lege einen neuen Firmenkontakt QAC-400 kontrolliert an.", "Welche Projekte gehören zu diesem Kunden?", "Welche offenen Aufgaben gibt es für den Kunden?", "Wann gab es zuletzt Kontakt mit dem Kunden?", "Fasse die Kundenhistorie zusammen.",
  ],
  tasks: [
