...
const groups: Record<string, string[]> = {
  ...
  invoices: [
    "Erstelle einen Rechnungsentwurf für Projekt GLR-449.", "Erstelle eine Rechnung für OK immocare mit Leistungsdatum 31.07.2026.", "Prüfe den Rechnungsentwurf vor der Fakturierung.", "Welche Nachweise fehlen vor der Fakturierung?", "Gibt es schon eine Rechnung zu diesem Angebot?", "Welche Arbeitszeiten sind noch nicht abgerechnet?", "Zeig mir offene Rechnungen.", "Warum ist diese Rechnung noch nicht fakturierbar?", "Fakturiere und versende die Rechnung nicht automatisch.", "Welche Forderungen sind überfällig?",
  ],
  onlineRequests: [
