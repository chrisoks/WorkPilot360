...
export async function PATCH(
  ...
  try {
    ...
    const isAutomationManagement = body.actionId === "automation.manage";
  ...
  try {
    ...
    if (body.command === "cancel") {
      const actionDraft = isOfferFinalization
        ...
        : isTimeManagement
        ? await cancelJarvisTimeManagementDraft(
            previewId,
            resolved.binding,
            body.revision
          )
        ...
        : isProjectLifecycle
        ? await cancelJarvisProjectLifecycleDraft(
            previewId,
            resolved.binding,
            body.revision
          )
    ...
    const actionDraft = isOfferFinalization
      ...
      : isTimeManagement
      ? await confirmJarvisTimeManagementDraft(
          previewId,
          resolved.binding,
          body.revision,
          typeof body.confirmationText === "string" ? body.confirmationText : ""
      ...
      : isProjectLifecycle
      ? await confirmJarvisProjectLifecycleDraft(
          previewId,
          resolved.binding,
          body.revision,
          typeof body.confirmationText === "string" ? body.confirmationText : ""
          ...
          ? isOfferFinalization
            ...
            ? planningRequestDecision === "cancel_series"
              ...
              : planningRequestDecision === "withdraw_series"
                ...
                : planningRequestDecision === "approve_series"
                  ? "Die vollständig angezeigte offene Terminwunschserie wurde nach deiner exakten Bestätigung atomar und genau einmal freigegeben. Historie, Projektlogbuch und Hinweise wurden für alle Serienwünsche gemeinsam geschrieben."
                  : planningRequestDecision === "reject_series"
                    ? "Die vollständig angezeigte offene Terminwunschserie wurde nach deiner exakten Bestätigung atomar und genau einmal begründet abgelehnt. Historie, Projektlogbuch und Hinweise wurden für alle Serienwünsche gemeinsam geschrieben."
