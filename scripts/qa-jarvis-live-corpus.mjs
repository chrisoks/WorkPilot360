...
async function main() {
  ...
  const expectedTopics = {
    ...
    "planning-09": "projects.contract-month-boundaries",
    "time-01": "time.net-duration-and-breaks",
    "time-03": "recurring.hourly.invoice-draft",
    ...
    "offers-05": "recurring.hourly.forecast",
    "invoices-10": "recurring.hourly.customer-text",
    "projects-09": "projects.billing-interval.semiannual",
    "customers-10": "sales-journal.workflow",
