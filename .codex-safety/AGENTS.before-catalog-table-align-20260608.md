...
- Artikel & Leistungen UI 2026-06-08: Die Stammdatentabellen fuer Artikel,
  Leistungen, Pakete und Verkaufspreise behalten ihre Tabellenlogik, sollen aber
  nicht mehr in der alten dunklen ERP-Optik erscheinen. Tabellenkopf hell,
  Filterzeile ruhig, Status als Clip (`Aktiv`/`Inaktiv`) und Aktionen als
  beschriftete Buttons (`Bearbeiten`, `Duplizieren`, `Deaktivieren`), keine
  Fragezeichen-Buttons.
