...
- Verkaufschancen-Tabelle 2026-06-08: Die Hauptuebersicht der Verkaufschancen
  ...
  und die eigentlichen Aktionen in der Maske liegen. Die Nummer (`VC-xxxx`) ist
  aktuell eine UI-Nummer aus der geladenen Liste, kein persistierter
  Datenbank-Nummernkreis. Wenn Verkaufschancen spaeter revisionssicher
  referenziert werden sollen, sollte ein echtes gespeichertes Nummernfeld mit
  API-/Ensure-Logik ergaenzt werden.
