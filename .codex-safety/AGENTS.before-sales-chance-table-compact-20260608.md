...
- Verkaufschancen-Tabelle 2026-06-08: Die Hauptuebersicht der Verkaufschancen
  ...
  `Bearbeiten`-Einstieg. Links gibt es eine sichtbare Verkaufschancen-Nummer
  (`VC-xxxx`), die die Detailmaske oeffnet. Diese Nummer ist aktuell eine
  UI-Nummer aus der geladenen Liste, kein persistierter Datenbank-Nummernkreis.
  Wenn Verkaufschancen spaeter revisionssicher referenziert werden sollen,
  sollte ein echtes gespeichertes Nummernfeld mit API-/Ensure-Logik ergaenzt
  werden.
